...
using Content.Client.UserInterface.Systems.Language; // Einstein Engines - Language
...
public sealed partial class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private LanguageMenuUIController _language = default!; // Einstein Engines - Language
    ...
    public void UnloadButtons()
    {
        ...
        _language.UnloadButton(); // Einstein Engines - Language
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _language.LoadButton(); // Einstein Engines - Language
    }
}
