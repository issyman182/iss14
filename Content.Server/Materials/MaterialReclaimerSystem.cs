...
public sealed partial class MaterialReclaimerSystem : SharedMaterialReclaimerSystem
{
        ...
        MaterialReclaimerComponent? component = null)
    {
        ...
        if (CanDamageAndGib(uid, item, component))
        {
            ...
            {
                var logImpact = HasComp<HumanoidAppearanceComponent>(item) ? LogImpact.Extreme : LogImpact.Medium; // iss14: classic appearance
                ...
                _body.GibBody(item, true); // iss14: classic body gib
