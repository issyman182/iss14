...
public sealed partial class GameruleOnSignSytem : EntitySystem
{
    ...
    private void OnMapInit(EntityUid uid, GameruleOnSignComponent comp, MapInitEvent init)
    {
        if (comp.KeepFaxable)
            return;
    ...
    private void OnPaperSigned(EntityUid uid, GameruleOnSignComponent component, ref PaperSignedEvent args)
    {
