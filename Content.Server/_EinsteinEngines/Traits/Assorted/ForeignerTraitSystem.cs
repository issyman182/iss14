...
public sealed partial class ForeignerTraitSystem : EntitySystem
{
    ...
    [Dependency] private SharedTransformSystem _transform = default!; // iss14: for SetCoordinates
        ...
        out EntityUid result)
    {
        ...
        _transform.SetCoordinates(translator, Transform(uid).Coordinates); // iss14: obsolete setter replaced
