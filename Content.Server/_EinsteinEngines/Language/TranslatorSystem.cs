...
using Content.Shared.PowerCell; // iss14: PowerCellSystem lives in shared here
...
public sealed partial class TranslatorSystem : SharedTranslatorSystem // iss14: partial (RA0049)
{
    ...
    private void OnDetermineLanguages(EntityUid uid, IntrinsicTranslatorComponent component, ref DetermineEntityLanguagesEvent ev) // iss14: ByRefEvent
    {
    ...
    private void OnProxyDetermineLanguages(EntityUid uid, HoldsTranslatorComponent component, ref DetermineEntityLanguagesEvent ev) // iss14: ByRefEvent
    {
    ...
    private void OnPowerCellSlotEmpty(EntityUid translator, HandheldTranslatorComponent component, ref PowerCellSlotEmptyEvent args) // iss14: ByRefEvent
    {
    ...
    private void OnPowerCellChanged(EntityUid translator, HandheldTranslatorComponent component, ref PowerCellChangedEvent args) // iss14: ByRefEvent
    {
    ...
    private void OnItemToggled(EntityUid translator, HandheldTranslatorComponent component, ref ItemToggledEvent args) // iss14: ByRefEvent
    {
        var hasCharge = _powerCell.HasActivatableCharge(translator);
