...
public abstract partial class SharedLanguageSystem : EntitySystem // iss14: partial (RA0049)
{
    /// <summary>
    ...
    [Dependency] protected IPrototypeManager _prototype = default!; // iss14: not readonly (RA0051)
    [Dependency] protected SharedGameTicker _ticker = default!; // iss14: not readonly (RA0051)
