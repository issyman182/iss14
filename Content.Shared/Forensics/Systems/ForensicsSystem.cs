...
public sealed partial class ForensicsSystem : EntitySystem
{
    ...
    [SubscribeLocalEvent(before: [typeof(IngestionSystem), typeof(SharedAbsorbentSystem)])]
    ...
    {
        return Loc.GetString("forensic-residue", ("adjective", adjective));
    }

    private bool CanCleanResidue(CleansForensicsComponent cleaner, string residue)
    {
    ...
    private bool HasCleanableEvidence(CleansForensicsComponent cleaner, ForensicsComponent evidence)
    {
    ...
    private void OnCleanForensicsDoAfter(Entity<ForensicsComponent> component, ref CleanForensicsDoAfterEvent args)
    {
        ...
        targetComp.Residues.RemoveWhere(residue => CanCleanResidue(cleaner, residue));
